...
function BottomSheet({
  ...
  const onHandleTouchMove = e => {
    ...
    if (dy > 0) {
      ...
      if (sheetInnerRef.current) sheetInnerRef.current.style.transform = `translateY(${dy}px)`;
    }
  };
  const onHandleTouchEnd = () => {
    if (sheetInnerRef.current) sheetInnerRef.current.style.transform = "";
    if (dragDelta.current > 60) requestClose();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      animation: `${closing ? "sheetBackdropOut" : "sheetBackdropIn"} 190ms ease forwards`
    }
    ...
    style: {
      ...
      animation: `${closing ? "sheetSlideDown" : "sheetSlideUp"} 220ms cubic-bezier(0.22,1,0.36,1) forwards`
    }
  }, /*#__PURE__*/React.createElement("div", {
...
function SoldiersPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      marginTop: 14,
      animation: "panelExpand 180ms ease"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
...
function DutyRosterApp() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    rel: "stylesheet"
        ...
        @keyframes panelExpand { from { opacity: 0; transform: translateY(-6px); } to { opacity: 1; transform: translateY(0); } }
      `), /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 520,
      margin: "0 auto",
