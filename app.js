...
function BottomSheet({
  ...
  const onHandleTouchEnd = () => {
    ...
    if (sheetInnerRef.current) {
      if (shouldClose) {
        // snap back to baseline INSTANTLY (no transition) so the close animation
        // that's about to take over starts from a clean, consistent position —
        // mixing a transition with the CSS close-animation on the same property
        // caused a visible flash/glitch otherwise.
        sheetInnerRef.current.style.transition = "none";
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      // silently do nothing after the sheet had already slid up.
      animation: closing ? "sheetSlideDown 280ms cubic-bezier(0.22,1,0.36,1) forwards" : entered ? "none" : "sheetSlideUp 280ms cubic-bezier(0.22,1,0.36,1) forwards"
    }
  }, /*#__PURE__*/React.createElement("div", {
